...
def _validate_removed_freqai(conf: dict[str, Any]) -> None:
    if conf.get("freqai", {}).get("enabled", False):
        raise ConfigurationError("FreqAI support has been removed from this backtesting fork.")
...
def _validate_consumers(conf: dict[str, Any]) -> None:
    ...
    if emc_conf.get("enabled", False):
        raise ConfigurationError(
            "external_message_consumer support has been removed from this backtesting fork."
        )
